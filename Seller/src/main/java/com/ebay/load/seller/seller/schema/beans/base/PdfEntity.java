 ...
 * <pre class="code">
 * PdfEntity&lt;String&gt; entity = template.getForEntity("https://example.com", String.class);
 ...
 * public PdfEntity&lt;String&gt; handle() {
 *   URI location = ...;
 *   HttpHeaders responseHeaders = new HttpHeaders();
 *   responseHeaders.setLocation(location);
 *   responseHeaders.set("MyResponseHeader", "MyValue");
 *   return new PdfEntity&lt;String&gt;("Hello World", responseHeaders, HttpStatus.CREATED);
 * }
 * </pre>
 *
 ...
 * public PdfEntity&lt;String&gt; handle() {
 *   URI location = ...;
 *   return PdfEntity.created(location).header("MyResponseHeader", "MyValue").body("Hello World");
 * }
 * </pre>
 *
 ...
 */
public class PdfEntity<T> extends HttpEntity<T> {

    private final Object status;


    /**
     * Create a {@code PdfEntity} with a status code only.
     * @param status the status code
     */
    public PdfEntity(HttpStatus status) {
        this(null, null, status);
    }

    /**
     * Create a {@code PdfEntity} with a body and status code.
     * @param body the entity body
     * @param status the status code
     */
    public PdfEntity(@Nullable T body, HttpStatus status) {
        this(body, null, status);
    }

    /**
     * Create a {@code PdfEntity} with headers and a status code.
     * @param headers the entity headers
     * @param status the status code
     */
    public PdfEntity(MultiValueMap<String, String> headers, HttpStatus status) {
        this(null, headers, status);
    }

    /**
     * Create a {@code PdfEntity} with a body, headers, and a status code.
     * @param body the entity body
     * @param headers the entity headers
     * @param status the status code
     */
    public PdfEntity(@Nullable T body, @Nullable MultiValueMap<String, String> headers, HttpStatus status) {
        this(body, headers, (Object) status);
    }

    /**
     * Create a {@code PdfEntity} with a body, headers, and a raw status code.
     * @param body the entity body
     * @param headers the entity headers
     * @param rawStatus the status code value
     * @since 5.3.2
     */
    public PdfEntity(@Nullable T body, @Nullable MultiValueMap<String, String> headers, int rawStatus) {
     ...
     * Private constructor.
     */
    private PdfEntity(@Nullable T body, @Nullable MultiValueMap<String, String> headers, Object status) {
        super(body, headers);
    ...
    public boolean equals(@Nullable Object other) {
        ...
        PdfEntity<?> otherEntity = (PdfEntity<?>) other;
    ...
    /**
     * A shortcut for creating a {@code PdfEntity} with the given body
     * and the status set to {@linkplain HttpStatus#OK OK}.
     * @param body the body of the response entity (possibly empty)
     * @return the created {@code PdfEntity}
     * @since 4.1
     */
    public static <T> PdfEntity<T> ok(@Nullable T body) {
        return ok().body(body);
    }
     ...
     * @since 5.1
     */
    public static <T> PdfEntity<T> of(Optional<T> body) {
        Assert.notNull(body, "Body must not be null");
        return body.map(PdfEntity::ok).orElseGet(() -> notFound().build());
    }
    ...
    public interface BodyBuilder extends HeadersBuilder<BodyBuilder> {
         ...
         */
        <T> PdfEntity<T> body(@Nullable T body);
    }
    ...
    private static class DefaultBuilder implements BodyBuilder {
        ...
        @Override
        public <T> PdfEntity<T> build() {
            return body(null);
        }

        @Override
        public <T> PdfEntity<T> body(@Nullable T body) {
            return new PdfEntity<>(body, this.headers, this.statusCode);
        }
    }
