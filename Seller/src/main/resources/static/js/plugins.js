function MainCtrl(dataFactory) {
 ...
 this.changeIt=function(position,obj1){
 ...
 // ..or as one object
 this.settings = {afterChange:this.changeIt,afterRemoveRow: this.destroy,afterCreateRow:this.afterCreate,
   contextMenu: [
  ...
  function dataFactory() {
    return {
      ...
      generateArrayOfArrays: function(rows, cols) {
          return Handsontable.helper.createEmptySpreadsheetData(rows , cols );
      }
    };
  }
  function changeIt(){
  console.log("working,,dd");
  }
